...
async function create(configuration) {
    ...
    const migrationFolder = (0, node_path_1.resolve)(migrationsFolder, `${migrationName}`);
    ...
    const upMigrationTemplate = (0, fs_1.readFileSync)((0, node_path_1.resolve)(__dirname, 'migration-templates/up.template.ts'));
    const downMigrationTemplate = (0, fs_1.readFileSync)((0, node_path_1.resolve)(__dirname, 'migration-templates/down.template.ts'));
